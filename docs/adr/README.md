...
| ID | Decision | Status |
|---|---|---|
| [ADR-001](ADR-001-single-public-repository.md) | A public repository for source, content, docs and assets | accepted |
| [ADR-002](ADR-002-astro-static-stack.md) | Astro and static stack | accepted |
| [ADR-003](ADR-003-first-class-bilingual-routing.md) | Persian/English first-class with symmetrical route | accepted |
| [ADR-004](ADR-004-engineering-editorial-design.md) | The visual language of Engineering Editorial | accepted |
...
| [ADR-012](ADR-012-density-calibrated-editorial-layout.md) | Density-calibrated editorial layout | accepted |
