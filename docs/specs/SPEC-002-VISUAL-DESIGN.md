...
| Implemented by | `TASK-0102`, `TASK-0201`, `TASK-0301`, `TASK-0505`, `TASK-0507` |
...
- Footer social links pair a decorative 16px line icon with an explicit localized text label; icon-only social links are prohibited.
